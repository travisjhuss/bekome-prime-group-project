 ...
 */
 router.get('/', rejectUnauthenticated, (req, res) => {
    ...
    const sqlText = `
    SELECT "clients".clients_users_id, "clients".first_name, "clients".last_name, "clients".city, clients.state, "clients".pic, "clients".primary_reason, "clients".id,
    ...
    JOIN "clients_preferences" ON "clients_preferences".clients_users_id = "clients".clients_users_id
...
// SELECT "clients".clients_users_id, "clients".first_name, "clients".last_name, "clients".city, clients.state, "clients".pic, "clients".primary_reason,
// ARRAY_AGG("clients_preferences".preferences_id) AS "preferences_array" 
// FROM "clients"
// JOIN "clients_providers_favs" ON "clients_providers_favs".clients_users_id = "clients".clients_users_id
// JOIN "clients_preferences" ON "clients_preferences".clients_users_id = "clients".clients_users_id
// WHERE "clients_providers_favs".providers_users_id = $1
// GROUP BY clients.clients_users_id, clients.first_name, clients.last_name, clients.city, clients.state, clients.pic, clients.primary_reason;