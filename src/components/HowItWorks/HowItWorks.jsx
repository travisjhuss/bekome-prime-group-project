        ...
        <Grid container spacing={2} className="how-it-works-flow">
          <Grid item xs={4} align="center">
            ...
            <Typography className={classes.howWorksText}>
              Use our tools and guidance to understand and articulate your needs
              and preferences
            </Typography>
          </Grid>
          <Grid item xs={4} align="center">
            ...
            <Typography className={classes.howWorksText}>
              Our app allows you to find a list of providers matching your
              needs, and you have the power to choose your best fit
            </Typography>
          </Grid>
          <Grid item xs={4} align="center">
            ...
            <Typography className={classes.howWorksText}>
              Schedule, meet, and be equipped with the tools to bekome your best
              self right on this platform
            </Typography>
          </Grid>
        </Grid>
      </div>
