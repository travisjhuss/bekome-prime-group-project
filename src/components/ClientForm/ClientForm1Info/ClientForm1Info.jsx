  ...
  return (
    <Paper className={classes.paper} elevation={4}>
      <Grid container spacing={4}>
        ...
        <Grid item xs={4}>
          <Typography gutterBottom><b>What pronouns do you use?</b></Typography>
          ...
          <Typography gutterBottom><b>Add a profile photo:</b></Typography>
          <Typography variant="body2" gutterBottom>
            <i>not required</i>
          </Typography>
        ...
        <Grid item xs={4}>
          <Typography><b>What kind of insurance do you have?</b></Typography>
